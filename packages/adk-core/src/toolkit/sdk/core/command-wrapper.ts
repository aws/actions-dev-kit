import os from 'os';
import { isValidOutputVariableName, outputVariableNamePattern, sanitizeCommand } from '@aws/codecatalyst-adk-utils';
import { exec } from 'shelljs';
// @ts-ignore
import { ICommandOutput } from './core';

export function runCommand(cmd: string, sanitizeInput: boolean = true, disableStdInput: boolean = true, args?: string[]) {
