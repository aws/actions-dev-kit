...
export class WorkflowDefinition {
   ...
   * @returns
   */
  static validate(workflowLikeObject: any, _options?: Options): ValidatorResult {
  ...
  addAction<T extends types.Action | types.ActionGroup>(name: string, action: T, _options?: {}) {
